...
resource "aws_s3_bucket" "wa-lab-amrit-1242023" {
  bucket = "wa-lab-amrit-1242023t"
...
resource "aws_s3_bucket_acl" "example" {
  bucket = aws_s3_bucket.wa-lab-amrit-1242023.id
  acl    = "private"
}

resource "aws_cloudformation_stack" "Dependency-Monitoring-Lab" {
  name = "Dependency-Monitoring-Lab"

  parameters = {
    AvailabilityZone = "us-east-2"
    BucketName = "wa-lab-amrit-1242023"
    LatestAmiId = "/aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2"
    NotificationEmail = "amrit.lamichhane@adex.ltd"
